...
def generate_quicklinks_html(csv_file_path, output_html_path="ACT-StaffResources.html"):
    """
...
<head>
    ...
    <title>ACIT Staff Resources</title>
...
"""
            ...
            <div class="software-item" data-name="{name}">
                <a href="{link}" target="_blank" style="text-decoration: none; color: inherit;">
                    <span class="software-icon icon-atlas icon-color material-symbols-outlined" style="color: {random_color};">category</span>
...
generate_quicklinks_html('ACT-StaffResources.csv')