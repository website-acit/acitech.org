...
def generate_quicklinks_html(csv_file_path, output_html_path="ACT-Forms.html"):
    """
...
<body>
    <header>
        <div id="search-container">
            <input type="text" id="search-input" placeholder="Search Forms...">
        </div>
...
"""
            ...
            <div class="software-item" data-name="{name}">
                <a href="{link}" target="_blank" style="text-decoration: none; color: inherit;">
                    <span class="software-icon icon-atlas icon-color material-symbols-outlined" style="color: {random_color};">format_list_bulleted</span>
...
generate_quicklinks_html('ACT-Forms.csv')