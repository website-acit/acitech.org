...
def generate_quicklinks_html(csv_file_path, output_html_path="ACT-ITDepartmentResources.html"):
    """
...
<head>
    ...
    <title>ACIT IT Department Resources</title>
...
"""
        ...
        <div class="software-item" data-name="{name}">
            ...
            <div class="software-description">{name}</div>
                    ...
                    """
                    if name in ["Google Admin", "Google Apps Script", "Salto", "Service Desk", "Rise Vision", "Newline", "Promethean", "CTE Building Install Status", "CTE Building Install Worksheet"]:
...
generate_quicklinks_html('ACT-ITDepartmentResources.csv')
