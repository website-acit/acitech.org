...
"""
        ...
        <div class="software-item" data-name="{name}">
            ...
            <div class="software-description">{name}</div>
                    ...
                    """
                    if name in ["Realtime", "Smartpass", "Classwize (acvsd.nj.us)", "Freshservice", "HeroHQ", "acitech.org", "Knowledge Article Request"]:
...
generate_quicklinks_html('ACT-QuickLinks.csv')
